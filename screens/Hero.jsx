...
export default function Hero() {
    ...
    return (
        <View style={{ flex: 1, height: '100%', width: '100%' }}>
            ...
            <ImageBackground source={require('../assets/image/logo.png')} style={{ position: 'absolute', height: 250, top: 250, alignSelf: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center',opacity:0.8 }}>
